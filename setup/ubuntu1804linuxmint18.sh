...
# Script to setup an AOSP Build Environment on Ubuntu 18.04 and above and Linux Mint 18.x

clear
echo -e "Installing Dependencies!"
sudo apt update -y
sudo apt install python gnupg flex curl bison gperf libsdl1.2-dev libesd0-dev \
squashfs-tools build-essential zip libncurses5-dev zlib1g-dev openjdk-8-jre \
openjdk-8-jdk pngcrush rsync schedtool libssl-dev libwxgtk3.0-dev libxml2 libxml2-utils xsltproc lzop libc6-dev \
g++-multilib lib32z1-dev lib32ncurses5-dev lib32readline-dev libesd0-dev gcc-multilib liblz4-* pngquant \
...
lzma* liblzma* w3m adb fastboot maven ncftp htop imagemagick yasm zip libssl-dev clang cmake -y
