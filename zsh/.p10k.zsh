# Generated by Powerlevel10k configuration wizard on 2020-01-04 at 01:39 IST.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 60815.
# Wizard options: nerdfont-complete + powerline, small icons, lean, 2 lines, solid,
# no frame, darkest, compact, many icons, fluent, transient_prompt, instant_prompt=off.
